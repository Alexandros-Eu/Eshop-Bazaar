...
<html lang="en">
  ...
  <?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['logout'])) {
        // Update isLoggedIn column in the database and mark the user as logged in
  ...
  ?>
    ...
    <nav class="main-nav">
        ...
        <div class="nav-btn">
            <?php 
              echo $navbarButton; // Depending on the user state the option will be login or logout
            ?>
            <a href="cart.php">
    ...
    <?php
        ...
        $sql = "SELECT SKU, NAME_PROD, DESC_PROD, PRICE_PROD, CAT_PROD, PHOTO_PROD FROM PRODUCT"; // Getting the products from the database
    ...
    <?php
        while ($row = $result->fetch_assoc())
        {
            if ($row['CAT_PROD'] == "Shoes") 
            {
                ...
                // Sending SKU to add_to_cart.php (This way we add a product to their cart)
